...
import { FaBoxOpen, FaClipboardList, FaUsers, FaStore, FaSignOutAlt } from 'react-icons/fa'
  ...
  return (
    <div className='p-6 text-white'>
      ...
      <nav className="flex flex-col space-y-2">
        ...
        <FaUsers/>  <span>Users</span> </NavLink>
        ...
        <FaBoxOpen/>  <span>Products</span> </NavLink>
        ...
        <FaClipboardList/>  <span>Orders</span> </NavLink>
        ...
        <FaStore/>  <span>Shope</span> </NavLink>
      
      </nav>
      <div className="mt-6">
        <button onClick={handleLogout} className='bg-red-500 text-white hover:bg-red-600 py-2 px-4 w-full  rounded flex items-center justify-center space-x-2'> 
